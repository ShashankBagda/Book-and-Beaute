		...
		<div class="row">
			...
			<div class="col-md-6 offset-md-3">
				<div class="card my-card">
					<div class="card-body">
						<p class="text-center fs-3">Leave a Comment</p>
						...
						<form class="row g-3" action="../updateStatus" method="post">
							...
							<!-- which saloon give a comment / saloon Id -->
							<input type="hidden" name="saloonId" value="<%= appointment.getSaloonId()%>" class="form-control">
