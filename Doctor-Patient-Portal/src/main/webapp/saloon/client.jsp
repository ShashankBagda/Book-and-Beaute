...
<body>
	...
	<div class="container p-3 wrapper-container">
		<div class="row">
			<div class="col-md-12">
				<div class="card my-card">
					<div class="card-body">
						<p class="text-center text-success fs-3">Client Details</p>
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<%
								Saloon saloon = (Saloon) session.getAttribute("saloonObj");

								//SaloonDAO docDAO = new SaloonDAO(DBConnection.getConn());
								AppointmentDAO appDAO = new AppointmentDAO(DBConnection.getConn());
								List<Appointment> list = appDAO.getAllAppointmentByLoginSaloon(saloon.getId());
