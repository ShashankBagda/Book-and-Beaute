...
public class AppointmentDAO {
	...
	public boolean addAppointment(Appointment appointment) {
		...
		try {
			...
			String sql = "insert into appointment(userId, fullName, gender, age, appointmentDate, email, phone, saloonId, address, status) values(?,?,?,?,?,?,?,?,?,?)";
			...
			pstmt.setInt(8, appointment.getSaloonId());
	...
	public List<Appointment> getAllAppointmentByLoginUser(int userId) {
		...
		try {
			...
			while (resultSet.next()) {
				...
				appointment.setSaloonId(resultSet.getInt(9));
				appointment.setAddress(resultSet.getString(10));
				appointment.setStatus(resultSet.getString(11));
	...
	public List<Appointment> getAllAppointmentByLoginSaloon(int saloonId) {
		List<Appointment> appList = new ArrayList<Appointment>();
	...
	public boolean updateDrAppointmentCommentStatus(int apptId, int docId, String comment) {
		...
		try {
			...
			String sql = "update appointment set status=? where id=? and saloonId=?";
			PreparedStatement pstmt = this.conn.prepareStatement(sql);
