...
public class AppointmentServlet extends HttpServlet{
	...
	int saloonId = Integer.parseInt(req.getParameter("saloonNameSelect"));
	String address = req.getParameter("address");
	
	
	Appointment appointment = new Appointment(userId, fullName, gender, age, appointmentDate, email, phone, saloonId, address, "Pending");
