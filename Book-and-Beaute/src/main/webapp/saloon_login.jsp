		...
		<div class="row">
			<div class="col-md-4 offset-md-4">
				<div class="card my-card">
					<div class="card-header text-center text-black my-bg-color">
						<!-- <p class="fs-4 text-center mt-1"><i class="fa-solid fa-users"></i> <br>User Login</p> -->
						<p class="fs-4 text-center text-black mt-2">
							<i class="fa-solid fa-scissors"></i> Barber Login
						</p>
					</div>
					...
					<div class="card-body">
						...
						<form action="saloonLogin" method="post">
							...
							<button type="submit" class="btn my-bg-color text-black col-md-12">Submit</button>
						</form>
