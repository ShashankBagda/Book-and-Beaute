...
.my-bg-img{
	background: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, .4)),url("./img/slide3.png");
	height: 20vh;
	width: 100%;
	...
	<div class="container p-3">
		...
		<div class="row">
			...
			<div class="col-md-6 p-5">
				...
				<img alt="" src="img/slide1.png" width="100%" height="auto">
			</div>
						...
						<form class="row g-3" action="addAppointment" method="post">
							...
							<div class="col-md-6">
								<label class="form-label">Barber</label> <select
								 required="required" class="form-control" name="saloonNameSelect">
									<option selected="selected" disabled="disabled">---Select---</option>
									
									<%
									SaloonDAO saloonDAO = new SaloonDAO(DBConnection.getConn());
									List<Saloon> listOfSaloon = saloonDAO.getAllSaloon();
									for(Saloon d : listOfSaloon)
									
									{%>
									<!-- actually we take id of saloon from saloon table -->
							...
							<div class="col-md-12">
								<label class="form-label">Write Services</label>
